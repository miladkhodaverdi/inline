<?php
ob_start();
define('API_KEY','272326239:AAFoaDKYAtG2y4rcBMJ6N15iF59mdjqUrA0');
$the_admin_id = 0;
...
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot272326239:AAFoaDKYAtG2y4rcBMJ6N15iF59mdjqUrA0/'.trim($imag->result->file_path,"\\/");
